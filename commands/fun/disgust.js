...
module.exports = {
  ...
  run: async ( client, message, args ) => {
    ...
    if (message.guild && !message.mentions.members.size){
      ...
      return message.channel.send(embed.setDescription(`${message.member} est dégoûté..`));
      ...
      return message.channel.send(embed.setDescription(`${message.author} est dégoûté..`));
