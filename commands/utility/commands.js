  ...
  run: (client, message) => {
    ...
    return message.channel.send(
      ...
      .addField(
       ...
       .addField(
        '__**configuration**__',
        "`disableanisched`, `goodbyetoggle`, `setanischedch`, `setgoodbyech`, `setgoodbyemsg`, `setmute`, `setprefix`, `setsuggestch`, `setwelcomech`, `setwelcomemsg`, `togglevotenotif`, `unwatch`, `userxpreset`, `watch`, `welcometoggle`, `xpenable`, `xpexcempt`, `xpreset`, `xptoggle`"
       )
       .addField(
        '__**amusant**__',
       ...
       .addField(
        '__**utile**__',
        "`feedback`, `avatar`, `reportbug`, `define`, `emoji`, `jisho`, `listrole`, `reddit`, `steam`, `suggest`, `watching`"
       )
       .addField(
        '__**musique**__',
        "en maintenance"
