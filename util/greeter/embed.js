...
module.exports = (args, oldEmbed) => {
  ...
  if (embedProps.color?.match(/#[a-f0-9]{6}/i)){
    ...
    fails.push('Le **code hexadécimal de couleur** fourni n\'est pas valide. Veuillez vous assurer que vous transmettez un code hexadécimal valide');
  } else if (embedProps.color){
    success.push('**Embed#color** a été défini avec succès!')
  };
